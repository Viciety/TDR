class Rei{
    ...
    moves(inicialVerticalCoord, inicialHoritzontalCoord, taulell, nomesMenjant){
        ...
        if(nomesMenjant == false){
            if (!this.preMoves && !ScanCheck(taulell, this.color)){
                if (this.color){
                    if (taulell.getFitxaEnPosicio(7,7).peça == TORRE_BLANCA &&  taulell.getFitxaEnPosicio(7,7).preMoves == false && taulell.getFitxaEnPosicio(7, 6) == BUIDA && taulell.getFitxaEnPosicio(7, 5) == BUIDA){
                    ...
                    if(taulell.getFitxaEnPosicio(7,0).peça == TORRE_BLANCA &&  taulell.getFitxaEnPosicio(7, 0).preMoves == false && taulell.getFitxaEnPosicio(7, 1) == BUIDA && taulell.getFitxaEnPosicio(7, 2) == BUIDA && taulell.getFitxaEnPosicio(7, 3) == BUIDA){
                    ...
                    if (taulell.getFitxaEnPosicio(0,7).peça == TORRE_NEGRA &&  taulell.getFitxaEnPosicio(0,7).preMoves == false && taulell.getFitxaEnPosicio(0, 6) == BUIDA && taulell.getFitxaEnPosicio(0, 5) == BUIDA){
                    ...
                    if(taulell.getFitxaEnPosicio(0,0).peça == TORRE_NEGRA &&  taulell.getFitxaEnPosicio(0, 0).preMoves == false && taulell.getFitxaEnPosicio(0, 1) == BUIDA && taulell.getFitxaEnPosicio(0, 2) == BUIDA && taulell.getFitxaEnPosicio(0, 3) == BUIDA){
